...
<div class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="dashboard.html"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="" /></a>
        </div>
        <div class="headerinner">
            <ul class="headmenu">
                ...
                <li>
                    ...
                    <span class="headmenu-label">Grup Alumni</span>
                    </a>
                    <ul class="dropdown-menu newusers">
                        <li class="nav-header">Grup Alumni</li>
                        <li>
                            <a href="">
                                <img src="<?php echo base_url(); ?>assets/images/photos/thumb1.png" alt="" class="userthumb" />
                ...
                <li class="right">
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            <h5>Muhamad Taufik H. <small>- muhamad.taufikhidayat@live.com</small></h5>
                            <ul>
